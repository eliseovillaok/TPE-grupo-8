...
public class Viaje {
	 ...
	 * @param precio
	 */
	public Viaje(String origen, String destino, LocalDateTime fechaSalida,LocalDateTime fechaLlegada,
			String empresa, int tiempoEstimado, int asientosDisponibles, int precio) {
		super();
		this.origen = origen;
